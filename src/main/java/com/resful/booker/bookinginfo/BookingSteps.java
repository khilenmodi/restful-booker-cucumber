...
import com.resful.booker.model.BookingPojo;
import com.resful.booker.constants.EndPoint;
import com.resful.booker.model.BookingDates;
...
public class BookingSteps {
    ...
    public ValidatableResponse getAllBookingIds() {
        return SerenityRest.given().log().ifValidationFails()
                .when()
                .get(EndPoint.GET_ALL_BOOKING_IDS)
                .then();
    }
    ...
    public ValidatableResponse deleteBookingWithBookingId(int bookingId, String token) {
        return SerenityRest.given().log().ifValidationFails()
                ...
                .pathParam("bookingId", bookingId)
                .when()
                .delete(EndPoint.DELETE_BOOKING)
                .then();
    }
}
